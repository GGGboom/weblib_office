angular.module('storageManagementController', [])
    .controller('storageManagementController',
            ...
            sendRequest('/category/getCategoriesWithManagedGroup.action',
                {
                    ...
                    $scope.tree.push({name:'#root',displayName: '根目录', nodes: _nodes, leaf: false});
        ...
        $scope.addCategory = function(){
            $scope.currentModal = $("#addCategoryModal").modal({
                onCancel:function () {
       ...
       /* $scope.tabName = {'DEFAULT': '', 'PERMISSION': 'permission', 'DETAILINFO': 'detailInfo'};//tabName enum
        ...
        //最右界面加载
        $scope.templates=[
            {name:"groupDetail",url:"./tpl/storageManagementTpls/detailInfo.html"},
            {name:"addPermission",url:"./tpl/storageManagementTpls/addPermission.html"}
        ];
        ...
        $scope.editNode={};
        $scope.editCategoryOrGroup = function () {
            $scope.editNode = $scope.selectedNode;
            $scope.currentModal = $("#editCategoryOrGroupModal").modal({
                onCancel:function () {
                    $scope.currentModal.modal('close');
                    $scope.newGroup = {};
                }
        ...
        $scope.deleteCategoryOrGroup = function () {
            $scope.currentModal = $("#deleteCategoryOrGroupModal").modal({
                onCancel:function () {
                    $scope.currentModal.modal('close');
                    $scope.newGroup = {};
                }
