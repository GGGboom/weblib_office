...
$j(function(){
    ...
    $j("input[name='groupId']").val($j(parent.window.document).find("#build").attr("rel"));
	...
	up = new FancyUpload2($('demo-status'), $('demo-list'), { // options object
		...
		onLoad: function() {
			...
			/*$('demo-clear').addEvent('click', function() {
				...
				setTimeout(function(){$j(".uploadText").fadeIn(100)},100);
				return false;
			});*/
            if($('demo-upload') != null) {
...
<div class="container">
  <!-- See index.html -->
    <form action="<%=site%>/user/uploadImage.action" method="post" enctype="multipart/form-data" id="form-demo">
      <fieldset id="demo-fallback" style="display:none">
      <label for="demo-photoupload"> Upload a Photo:
      ...
      <div id="demo-status" class="hide">
        <div class="upLoadFunctionWrap"> <a href="#" id="demo-browse">添加图片</a><!-- | <a href="#" id="demo-clear">全部删除</a> | <a href="#" id="demo-upload">开始上传</a>--> <span class="current-text"></span></div>
              <ul id="demo-list">
       ...
       <span class="uploadText">请选择要上传的图片</span>
      </ul>
      </div>
    </form>
</div>
