...
import com.dcampus.common.util.CookieUtils;
...
public class Page<T> {
	...
	private int pageSize = PropertyUtil.getSearchDefaultPageSize(); // 页面大小，设置为“-1”表示不进行分页（分页无效）
	private String pageNoId = "pageNo";
	private String pageSizeId = "pageSize";
	
	private long count;// 总记录数，设置为“-1”表示不查询总数
	
	private int first;// 首页索引 由1开始
